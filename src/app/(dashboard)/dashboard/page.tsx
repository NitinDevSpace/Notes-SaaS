  ...
  return (
    <>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                <button className="w-full text-left px-4 py-3 rounded-lg bg-muted hover:bg-accent transition-colors" onClick={openModal}>
      ...
      <NoteModal
        ...
        onSave={(noteData: any) => {
          const newNote: Note = {
            id: Math.max(...recentNotes.map(n => n.id), 0) + 1,
        ...
        initialData={editingNote ? { title: editingNote.title, content: '', category: '' } : undefined}
      />
    </>
  )
}
